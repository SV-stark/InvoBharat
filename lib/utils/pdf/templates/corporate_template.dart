                  ...
                  pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
                    ...
                    pw.Expanded(
                      ...
                      if (profile.gstin.isNotEmpty)
                        pw.Text("GSTIN: ${profile.gstin}", style: const pw.TextStyle(fontSize: 10)),
                    ...
                    pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.end, children: [
                      ...
                      buildField("Place of Supply", invoice.placeOfSupply,
                          const pw.TextStyle(fontSize: 9), const pw.TextStyle(fontSize: 9)),
                      ...
                      pw.Expanded(
                          ...
                          child: pw.Column(
                              ...
                              children: [
                                ...
                                pw.Text("A/c No: ${profile.accountNo}",
                                    style: const pw.TextStyle(fontSize: 9)),
                      ...
                      pw.Expanded(
                          ...
                          child: pw.Column(children: [
                            pw.Container(
                                ...
                                child: pw.Column(children: [
                                  buildSummaryRow("Taxable Value", invoice.totalTaxableValue,
        ...
        footer: (final context) => pw.Container(
            ...
            child: pw.Center(
              child: pw.Text("Thank you for your business!",
                  style: pw.TextStyle(fontWeight: pw.FontWeight.bold, color: themeColor)),
            )),
      ),
    );
