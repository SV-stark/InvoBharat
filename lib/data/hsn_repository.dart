...
class HsnRepository {
  ...
  static const List<HsnCode> commonCodes = [
    ...
    HsnCode(code: '998211', description: 'Legal services including advocacy'),
    HsnCode(code: '998221', description: 'Financial auditing services'),
    HsnCode(
      code: '998222',
    ...
    HsnCode(code: '998312', description: 'Business consulting services'),
    // IT Services
    HsnCode(
      code: '998313',
      description:
    ...
    HsnCode(code: '998365', description: 'Sale of internet advertising space'),
    HsnCode(
      code: '998366',
    ...
    HsnCode(code: '998412', description: 'Mobile telecommunication services'),
    HsnCode(code: '998413', description: 'Internet telecommunication services'),
    // Maintenance
    HsnCode(
      code: '998711',
      description:
    ...
    HsnCode(code: '996712', description: 'Storage and warehousing services'),
    // Hospitality
    HsnCode(
      code: '996311',
      description:
    ...
    HsnCode(
      code: '998811',
      description: 'Services by way of printing',
      rate: 12,
    ),
    HsnCode(
      code: '998812',
    ...
    HsnCode(
      code: '854442',
      description: 'Other electric conductors, fitted with connectors (Cables)',
    ),
    // Electricals
    HsnCode(
      code: '850440',
    ...
    HsnCode(code: '850610', description: 'Manganese dioxide batteries'),
    HsnCode(
      code: '850720',
    ...
    HsnCode(code: '841810', description: 'Combined refrigerator-freezers'),
    HsnCode(
      code: '851610',
      description: 'Electric instantaneous or storage water heaters (Geysers)',
    ),
    // Furniture
    HsnCode(
      code: '940130',
    ...
    HsnCode(
      ...
      rate: 12,
    ), // Pharma often 12 or 5
    HsnCode(code: '330410', description: 'Lip make-up preparations'),
    HsnCode(
      code: '340111',
      description: 'Soap and organic surface-active products and preparations',
    ),
    HsnCode(
      code: '950300',
      description:
    ...
    if (_cachedJsonCodes == null) {
      try {
        final String jsonString = await rootBundle.loadString(
          'assets/data/hsn_sac.json',
        );
        final List<dynamic> jsonList = json.decode(jsonString);
        _cachedJsonCodes = jsonList
            .map((final e) => HsnCode.fromJson(e as Map<String, dynamic>))
            .toList();
      } catch (e) {
