...
mixin _$Client {
 ...
 String get id; String get name; String get profileId; String get gstin; String get address; String get email; String get phone; String get primaryContact; String get notes; String get state; String get pan; String get stateCode;
...
@useResult
$Res call({
 String id, String name, String profileId, String gstin, String address, String email, String phone, String primaryContact, String notes, String state, String pan, String stateCode
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String profileId,  String gstin,  String address,  String email,  String phone,  String primaryContact,  String notes,  String state,  String pan,  String stateCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Client() when $default != null:
return $default(_that.id,_that.name,_that.profileId,_that.gstin,_that.address,_that.email,_that.phone,_that.primaryContact,_that.notes,_that.state,_that.pan,_that.stateCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String profileId,  String gstin,  String address,  String email,  String phone,  String primaryContact,  String notes,  String state,  String pan,  String stateCode)  $default,) {final _that = this;
switch (_that) {
case _Client():
return $default(_that.id,_that.name,_that.profileId,_that.gstin,_that.address,_that.email,_that.phone,_that.primaryContact,_that.notes,_that.state,_that.pan,_that.stateCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String profileId,  String gstin,  String address,  String email,  String phone,  String primaryContact,  String notes,  String state,  String pan,  String stateCode)?  $default,) {final _that = this;
switch (_that) {
case _Client() when $default != null:
return $default(_that.id,_that.name,_that.profileId,_that.gstin,_that.address,_that.email,_that.phone,_that.primaryContact,_that.notes,_that.state,_that.pan,_that.stateCode);case _:
  return null;
...
class _Client implements Client {
  const _Client({required this.id, required this.name, this.profileId = 'default', this.gstin = '', this.address = '', this.email = '', this.phone = '', this.primaryContact = '', this.notes = '', this.state = '', this.pan = '', this.stateCode = ''});
...
@override@JsonKey() final  String primaryContact;
...
/// Create a copy of Client
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? profileId = null,Object? gstin = null,Object? address = null,Object? email = null,Object? phone = null,Object? primaryContact = null,Object? notes = null,Object? state = null,Object? pan = null,Object? stateCode = null,}) {
